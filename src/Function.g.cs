...
namespace SimultaneousGeometryAndPropertyOverrides
{
    public class Function
    {
        ...
        private IModelStore<SimultaneousGeometryAndPropertyOverridesInputs> store;

        public async Task<SimultaneousGeometryAndPropertyOverridesOutputs> Handler(SimultaneousGeometryAndPropertyOverridesInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<SimultaneousGeometryAndPropertyOverridesInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<SimultaneousGeometryAndPropertyOverridesInputs,SimultaneousGeometryAndPropertyOverridesOutputs>(store, SimultaneousGeometryAndPropertyOverrides.Execute);
